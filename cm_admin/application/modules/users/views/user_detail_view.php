<article class="col col-sm-9" id="mainContent">
    ...
    <div class="">        
        <ol class="breadcrumb">
            ...
            <li class="active breadcrumb-item">User Details</li> 
            <li class="right back"  style="width: 65px;"><a href="<?php echo base_url(); ?>users"><i class="fa fa-angle-left" style="position: relative; top: -2px;"></i> Back </a></li>
        </ol>
    </div>
    <div>
        <h2>Report</h2>
            ...
            <table class='table table-bordered table-striped'>
                ...
                <tbody>                       
                        ...
                        <td class="hidden-print">
                            <span style="cursor: pointer; font-size: 15px; color: #2c2b7b; font-weight: 600;"><a href="<?php echo base_url() . "users/1/report"; ?>"><i class="fa fa-arrow-circle-down"></i> Get</a></span>
                        </td>
                    </tr>
                    <tr>
                        <td>2</td>
