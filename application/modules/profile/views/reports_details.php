<article class="col col-sm-9" id="mainContent">
    ...
    <div class="">        
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo base_url() .'profile';?>">Users</a></li>
            <li class="breadcrumb-item"><a href="<?php echo base_url() .'profile/1';?>">Seema Reports</a></li>
            <li class="breadcrumb-item active">Report</li>
            <li class="right back"  style="width: 65px;"><a href="<?php echo base_url(); ?>profile/1"><i class="fa fa-angle-left" style="position: relative; top: -2px;"></i> Back </a></li>
        </ol>        
    </div>
    <div>
        <h2>Report: ID-001</h2>
    ...
    <div>       
        <div style="margin-top: 20px;">
            ...
            <h4>Hospital: <b>Aditya Birla Public School</b></h4>
