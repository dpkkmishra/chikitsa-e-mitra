        ...
        <div class="navbar-fixed">
            <nav style="color: #000; background: #f5f5f5; width: 80%; margin-top: -25px;">
                <div class="nav-wrapper">
                    <a href="<?php echo base_url(); ?>" class="brand-logo"><b>Chikitsa e-Mitra</b></a>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a href="#collapseOne" data-parent="#accordion" data-toggle="collapse">
                                            <span class="glyphicon glyphicon-cog"></span> My e-Mitra 
                                        </a>
                                    </h4>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url();?>hospitals"> My Hospitals</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <i class="fa fa-user-md"></i>
                                                        <a href="<?php echo base_url();?>profile/records/add"> Add a Medical Record</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
